...
// ===============================
// API Window
export const getApiWindows = () =>
  axios.get(`${API_BASE}/salary_sheets/api-window`);

export const updateApiWindow = (payload) =>
  axios.patch(
    `${API_BASE}/salary_sheets/api-window`,
    payload,
    {
      headers: {
...
export const downloadSalaryExcel = (month) => {
  return `${API_BASE}/salary_data/export?month-year=${encodeURIComponent(month)}`;
};
